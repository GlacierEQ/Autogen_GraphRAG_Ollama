...
$originalForeground = (Get-Host).UI.RawUI.ForegroundColor
$originalBackground = (Get-Host).UI.RawUI.BackgroundColor

# Define custom PowerShell functions
...
if (Test-Path "$venvPath\Scripts\Activate.ps1") {
    ...
    Write-Output "Could not find activation script. Manual activation may be required."
}
